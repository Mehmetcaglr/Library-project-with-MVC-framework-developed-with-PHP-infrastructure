...
<html lang="en">
  ...
  <body>
    <div class="container-scroller">
      ...
      <?php include "portion/navbar.php"; ?>
      <!-- partial -->
      <div class="container-fluid page-body-wrapper">
        <!-- partial:partials/_sidebar.html -->
          <?php include "portion/aside.php"; ?>
        <!-- partial -->
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="d-flex mt-3 py-2 border-bottom">
                          <img class="img-sm rounded-circle" src="<?php echo asset("images/faces/face3.jpg"); ?> " alt="profile image">
                        ...
                        <div class="d-flex py-2 border-bottom">
                          <img class="img-sm rounded-circle" src="<?php echo asset("images/faces/face4.jpg"); ?> " alt="profile image">
                          <div class="wrapper ml-2">
